...
const ExpensesForm = ({ setPage }) => {
  ...
  const handleSubmit = (e) => {
    ...
    SendNewExpenses(newExp , (d)=>setPage(0),(e)=>e.currentTarget.reset())
  ...
  return (
    <form onSubmit={handleSubmit} className='w-full flex flex-col items-center rounded-xl border-2 border-gray-700 backdrop-blur-lg	justify-evenly shadow-2xl'>
      <button type={"button"} onClick={()=>{setPage(0)}} className='w-10/12 text-left' >{"חזור >"}</button>
